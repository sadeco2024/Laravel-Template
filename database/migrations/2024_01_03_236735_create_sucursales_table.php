...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('sucursales', function (Blueprint $table) {
            ...
            $table->foreignId('correo_id')->nullable(false)->constrained('correos')->onUpdate('cascade')->onDelete('restrict');
            
            $table->foreignId('comentario_id')->nullable()->constrained('comentarios')->onUpdate('cascade')->onDelete('restrict');
